...
class GMLlamaAttention(LlamaAttention):
    ...
    def __init__(self, config: LlamaConfig, layer_idx: Optional[int] = None):
        ...
        self.mem_proj = GLU(3, True, self.num_key_value_groups, config.num_key_value_heads, self.head_dim, self.head_dim, bias=True, tailnorm=False)
        self.gate_proj = GLUGate(2, True, self.scaling, self.num_key_value_groups, config.num_key_value_heads, self.head_dim, self.head_dim, bias=True, tailnorm=False)
