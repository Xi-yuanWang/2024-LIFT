...
#SBATCH -o logs/%j-VanGate-musique-QA60-C3M7-LR2e-3warmup-musique.out.log
#SBATCH -e logs/%j-VanGate-musique-QA60-C3M7-LR2e-3warmup-musique.err.log
#SBATCH --gres=gpu:4
...
python scripts/mp_wrapper_longbench.py \
    ...
    --output_file outputs/VanGate/musique-QA60-C3M7-LR2e-3warmup-musique.jsonl \
    --subprocess_args \
