...
#SBATCH -o logs/%j-VanGate-narrativeqa-QA30-C3M5-LR2e-3warmup-narrativeqa.out.log
#SBATCH -e logs/%j-VanGate-narrativeqa-QA30-C3M5-LR2e-3warmup-narrativeqa.err.log
#SBATCH --gres=gpu:4
