...
#SBATCH -o logs/%j-VanGate-narrativeqa-QA10-C3M5-LR2e-3warmup-narrativeqa.out.log
#SBATCH -e logs/%j-VanGate-narrativeqa-QA10-C3M5-LR2e-3warmup-narrativeqa.err.log
#SBATCH --gres=gpu:4
...
python scripts/mp_wrapper_longbench.py \
    ...
    --output_file outputs/VanGate/narrativeqa-QA10-C3M5-LR2e-3warmup-narrativeqa.jsonl \
    --subprocess_args \
