...
#SBATCH -o logs/%j-VanGate-rICL-QA0-C8-musique.out.log
#SBATCH -e logs/%j-VanGate-rICL-QA0-C8-musique.err.log
#SBATCH --gres=gpu:4
...
python scripts/mp_wrapper_longbench.py \
    ...
    --output_file outputs/VanGate/rICL-QA0-C8-musique.jsonl \
    --subprocess_args \
