...
#SBATCH -o logs/%j-VanGate-rICL-QA0-C8-narrativeqa.out.log
#SBATCH -e logs/%j-VanGate-rICL-QA0-C8-narrativeqa.err.log
#SBATCH --gres=gpu:4
...
python scripts/mp_wrapper_longbench.py \
    ...
    --output_file outputs/VanGate/rICL-QA0-C8-narrativeqa.jsonl \
    --subprocess_args \
