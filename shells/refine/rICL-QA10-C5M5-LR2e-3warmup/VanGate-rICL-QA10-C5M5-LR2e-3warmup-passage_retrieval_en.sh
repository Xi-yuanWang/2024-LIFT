...
#SBATCH -o logs/%j-VanGate-rICL-QA10-C5M5-LR2e-3warmup-passage_retrieval_en.out.log
#SBATCH -e logs/%j-VanGate-rICL-QA10-C5M5-LR2e-3warmup-passage_retrieval_en.err.log
#SBATCH --gres=gpu:4
...
python scripts/mp_wrapper_longbench.py \
    ...
    --output_file outputs/VanGate/rICL-QA10-C5M5-LR2e-3warmup-passage_retrieval_en.jsonl \
    --subprocess_args \
