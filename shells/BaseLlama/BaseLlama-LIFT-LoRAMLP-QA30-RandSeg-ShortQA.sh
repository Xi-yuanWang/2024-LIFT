...
#SBATCH -c 16
#SBATCH -o logs/%j-BaseLlama-LIFT-LoRAMLP-QA30-RandSeg-ShortQA.out.log
#SBATCH -e logs/%j-BaseLlama-LIFT-LoRAMLP-QA30-RandSeg-ShortQA.err.log
#SBATCH --gres=gpu:4
#SBATCH --qos=16gpu-hgx
#SBATCH -J BaseLlama-LIFT-LoRAMLP-QA30-RandSeg-ShortQA
#SBATCH --nodes=1
...
python scripts/mp_wrapper.py \
    ...
    --output_file outputs/BaseLlama-LIFT-LoRAMLP-QA30-RandSeg-ShortQA.jsonl \
    --num_test 40 \
    --subprocess_args \
    --overwrite True \
    --num_syn_qa 30 \
