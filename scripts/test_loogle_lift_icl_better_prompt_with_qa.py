...
class ICLContextDataset(Dataset):
    ...
    def __init__(self, context: str, tokenizer: PreTrainedTokenizer, model_max_length: int=4096, block_size: int=256, len_segment: int=8, len_offset: int=3):
        ...
        LIFT_ICL_PROMPT = """\n\n\n The above text represents an excerpt from a larger article. The beginning and end of the article are provided, with the middle section omitted and represented by ellipses (...). Please keep in mind that you do not have access to the full text, just this partial version. Please recite the following segment from the text provided above: \n\n\n"""
...
LOOGLEFORMAT = "The article {title}: \n{input}\n\n\nThe above text represents an excerpt from a larger article. The beginning and end of the article are provided, with the middle section omitted and represented by ellipses (...). Please keep in mind that you do not have access to the full text, just this partial version. Please answer the question based on {title}.\nQuestion: {question}\nAnswer: "
LOOGLEFORMAT_COT = None
