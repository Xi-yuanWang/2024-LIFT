...
python scripts/test_loogle_lift_full.py \
    ...
    --output_file outputs/subset.full.debug.LGM0-0.4.alsoCOT.jsonl \
    --output_dir models/qwentrain.full.LGM0-0.5 \
    --overwrite False \
    --num_syn_qa 0 \
    --title_option 1 \
    --generator_name_or_path /ceph/home/muhan01/huggingfacemodels/Qwen2.5-32B-Instruct \
    --model_name_or_path models/qwentrain.full.LGM0-0.4 \
